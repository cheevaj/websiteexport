  ...
  <div class="background_color">
    ...
    <v-card-actions class="pa-2" style="background-color: rgb(26, 26, 0)">
      ...
      <v-card-text class="pa-0">
        <h2 class="text-center color_CL custom-font">{{ en ? "ປະຫວັດ C'Care ລົງທະບຽນເເພັກເກັດໃຫ້ລູກຄ້າ." : "History of CCare's register package for customer."}}</h2>
      </v-card-text>
      <div></div>
    </v-card-actions>
    <v-card
    ...
    >
      ...
      >
        ...
        <br />
        <h2>
          <span style="color: rgb(255, 255, 0)">CCare's register&nbsp;</span
      ...
      >
        ...
        <br />
        <h2 class="custom-font"><span class="custom-font" style="color: rgb(255, 255, 0)">{{en ? 'ຍັງບໍ່ມີ' :'Data'}}</span>{{ en ? 'ຂໍ້ມູນ' : 'not found' }}</h2>
      </v-card>
    </v-card-text>
  </div>
</template>
