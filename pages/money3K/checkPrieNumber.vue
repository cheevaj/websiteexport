    ...
    <div>
      ...
      <v-card-actions class="pa-2" style="background-color: rgb(26, 26, 0)">
        ...
        <v-card-text class="pa-0">
          <h2 class="text-center color_CL custom-font" style="color: #ffff00;">{{en ? 'ຂໍ້ມູນ ແລະ ລາຄາເບີ.' : 'Information and Price SIS.'}}</h2>
        </v-card-text>
        <div></div>
      </v-card-actions>
      <v-card
      ...
      >
        ...
        >
        <h3 class="custom-font">{{en ? 'ກະລຸນາປ້ອມເບີໂທລະສັບໃໝ່.' : 'Enter your new number phone.'}}</h3>
          <br />
          ...
          <h2 class="custom-font">
            {{en ? "ບໍ່ພົບຂໍ້ມູນຂອງເບີ" :"SIS's data is not found"}}
          </h2>
        </v-card>
        <v-card
          v-else
        ...
        >
          ...
          <br />
          <h2 class="custom-font">{{en ? 'ບໍ່ພົບຂໍ້ມູນຂອງເບີ' : 'Data not found'}}</h2>
        </v-card>
      </v-card-text>
    </div>
  </template>
